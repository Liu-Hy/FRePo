...
def main(dataset_name, data_path=None, zca_path=None, train_log=None, train_img=None, save_image=True,
    ...
    for fold in range(num_folds):
        ...
        key_ls = sorted(step_per_prototpyes.keys())
        for k in key_ls:
            if k >= num_prototypes:
                num_online_eval_updates = step_per_prototpyes[k]
                print("num_online_eval_updates: ", num_online_eval_updates)
                break
    ...
    print("final mean: ", np.mean(accs_all_exps[arch]))
